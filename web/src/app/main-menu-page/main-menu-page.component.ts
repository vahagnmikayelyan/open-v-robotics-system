...
import { LucideAngularModule, Plus, QrCode, Settings, Wrench, Download, Upload, Wifi } from 'lucide-angular';
...
import { WifiDialogComponent } from '../../components/wifi-dialog/wifi-dialog.component';
import { QrDialogComponent } from '../../components/qr-dialog/qr-dialog.component';

@Component({
  selector: 'main-menu-page',
  standalone: true,
  imports: [RouterLink, LucideAngularModule, NgFor, NgIf, UiLoaderComponent, ProgramCardComponent, DragScrollDirective, WifiDialogComponent, QrDialogComponent],
...
export class MainMenuPageComponent implements OnInit {
  ...
  readonly LucideIcons = { QrCode, Settings, Wrench, Plus, Download, Upload, Wifi };
  isConnectDialogOpen = signal(false);
  isWifiDialogOpen = signal(false);
